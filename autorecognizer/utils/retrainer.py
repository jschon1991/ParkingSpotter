...
if __name__ == '__main__':
    image_dir = os.path.join(PROJECT_ROOT, 'media', 'learn_data')
    output_graph = os.path.join(PROJECT_ROOT, 'media', 'data', 'car_park_graph.pb')
    output_labels = os.path.join(PROJECT_ROOT, 'media', 'data', 'car_park_labels.txt')
    summaries_dir = os.path.join(PROJECT_ROOT, 'media', 'tmp', 'retrain_logs')
    training_steps = 4000
    learning_rate = 0.01
    ...
    model_dir = os.path.join(PROJECT_ROOT, 'media', 'tmp', 'imagenet')
    bottleneck_dir = os.path.join(PROJECT_ROOT, 'media', 'tmp', 'bottleneck')
